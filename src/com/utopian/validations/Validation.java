package com.utopian.validations;
...
public class Validation {
   ...
   private static final  String DOB_REGEX ="0?[1-9]|[12][0-9]|3[01])/(0?[1-9]|1[012])/((19|20)\\d\\d)";
    ...
    private static final String PHONE_MSG = "must be of 10 digit";
    public static final String  PASSWORD_MSG= "Password should be more than 5 characters";
    public static final String  DOB_MSG= "Invalid format";
