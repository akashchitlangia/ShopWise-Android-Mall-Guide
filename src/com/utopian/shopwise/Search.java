...
public class Search extends ActionBarActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		rl=(RelativeLayout) findViewById(R.id.relative_search);
...
/*
		Bundle args = getArguments();
		 if (args  != null && args.containsKey("brand"))
		     String userId = args.getString("brand");*/
		...
		int length = ((TextView) findViewById(R.id.search_bar)).getText().toString().length();
        searchtxt.setSelection(length);
		//Auto Search
	...
	private class DownloadJSON extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String args) {
			...
			if(success == 1){
				...
				adapter = new LazyAdapter(Search.this, arraylist);
		...
		//		Toast.makeText(Search.this, ""+position,Toast.LENGTH_LONG).show();
			...
			//	rl.setBackgroundResource(R.drawable.icon_nobrand);
				Toast.makeText(Search.this, "No Such Brand!!",Toast.LENGTH_LONG).show();
