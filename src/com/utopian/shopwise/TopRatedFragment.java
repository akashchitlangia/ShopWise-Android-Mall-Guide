...
public class TopRatedFragment extends Fragment {
	...
	private static final String TOPRATED_URL = "http://utopiansolutions.co.in/db/toprated.php";
...
public TopRatedFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /* Intent intent = new Intent(getActivity(),TopRated.class);
       ...
       */ 
		  ...
		  rootView.setOnKeyListener( new OnKeyListener() {
				...
				public boolean onKey(View v, int keyCode, KeyEvent event) {
					// TODO Auto-generated method stub
					 ...
					 Intent intent = new Intent(getActivity(),com.utopian.shopwise.MainActivity.class);
		...
		//searchtxt.setText(brand);

		new DownloadJSONTopRated().execute();	
...
if (activities.size() == 0)
{
	...
	private class DownloadJSONTopRated extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				json = jsonParser.getJSONFromUrl(TOPRATED_URL);
