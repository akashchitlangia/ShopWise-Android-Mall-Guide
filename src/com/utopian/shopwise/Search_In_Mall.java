...
public class Search_In_Mall extends Activity{
		...
		private static final String Search_URL = "http://utopiansolutions.co.in/db/mall.php";
		private static final String Search_URL_SEARCH = "http://utopiansolutions.co.in/db/search_in_mall.php";
...
String name_mall;
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			name_mall = intent.getStringExtra("mall");
	...
	public void onClick(View v) {
		...
		private class DownloadJSONCategory extends AsyncTask<String, String, String> {
			...
			protected void onPreExecute() {
				...
				mProgressDialog = new ProgressDialog(Search_In_Mall.this);
			...
			protected String doInBackground(String... args) {
				...
				try {
					...
					params.add(new BasicNameValuePair("mall",name_mall));
		...
		//	return String;
			...
			protected void onPostExecute(String args) {
				...
				if(success == 1){
					...
					adapter = new LazyAdapter(Search_In_Mall.this, arraylist);
					...
					mProgressDialog.dismiss();
					Toast.makeText(Search_In_Mall.this, "No Brand",Toast.LENGTH_LONG).show();
